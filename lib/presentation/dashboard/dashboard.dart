...
import 'package:food_ninja/presentation/chat/chat_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  bool _bottomNavigationVisible = true; // Add this variable
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Visibility(
        visible: _bottomNavigationVisible,
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: Colors.black38, spreadRadius: 1, blurRadius: 120),
            ],
          ),
          child: Container(
            child: ClipRRect(
              ...
              child: BottomNavigationBar(
                              ...
                              gradient: LinearGradient(
                                colors: _selectedIndex == 0
                                    ? [
                                        Color(0xFFAFFFCD),
                                        Color(
                                            0xFFAFFFCD), // Lighter shade of #53E88B
                                      ]
                                    : [
                                        Colors.transparent,
                                        Colors.transparent,
                  ...
                  BottomNavigationBarItem(
                    icon: _selectedIndex == 2
                        ? Container(
                            margin: EdgeInsets.only(left: 10, top: 10),
                            padding: EdgeInsets.symmetric(
                                vertical: 12, horizontal: 0), // Adjust padding
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                ...
                onTap: (index) {
                  setState(() {
                    ...
                    if (index == 2) {
                      // If the user selects the cart screen, hide the bottom navigation
